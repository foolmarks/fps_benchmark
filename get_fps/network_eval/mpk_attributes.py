...
class MPKAttrs(object):
    ...
    needed to run an .lm/elf file on a DevKit and obtain FPS KPIs.
    ...
    def __init__(self, mpk_dict):
        ...
        assert plugin['kernel'] == "tessellation_transform", \
            "Tessellation plugin expected in MPK JSON file."
        self.tessellation_slice_height = plugin['params']['slice_height']
        self.tessellation_slice_width = plugin['params']['slice_width']
        self.tessellation_slice_channels = plugin['params']['slice_channels']
